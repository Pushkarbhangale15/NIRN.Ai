...
def build_draft_prompt(language: str) -> str:
    """
    Dynamically build the drafting system prompt based on the requested language.
    This saves over 50% of input context tokens for local models like Ollama,
    speeding up prompt pre-fill significantly.
    """
    is_marathi = language.lower() == "marathi" or language.lower() == "mr"
    ...
    if is_marathi:
        template = (
            "═══════════════════════════════════════════════════\n"
            "OFFICIAL MARATHI FORMAT (MANDATORY)\n"
            "═══════════════════════════════════════════════════\n"
            "महाराष्ट्र शासन\n"
        ...
        rules = (
            ...
            "═══════════════════════════════════════════════════\n"
            "• Produce the document in Marathi script (Devanagari) — never mix English headings.\n"
            ...
            "• Address: हुतात्मा राजगुरु चौक, मादाम कामा मार्ग, मंत्रालय मुंबई-३२\n"
            "• Use today's date for 'दिनांक:'\n"
            "• CRITICAL: Do NOT output any Cyrillic, Russian, Bulgarian, or non-Marathi characters.\n\n"
            "═══════════════════════════════════════════════════\n"
            ...
            "• Use Unicode Devanagari script exclusively.\n\n"
        )
    else:
        template = (
            "═══════════════════════════════════════════════════\n"
            "OFFICIAL ENGLISH FORMAT (MANDATORY)\n"
            "═══════════════════════════════════════════════════\n"
            "GOVERNMENT OF MAHARASHTRA\n"
        ...
        rules = (
            ...
            "LANGUAGE & FORMAT RULES\n"
            "═══════════════════════════════════════════════════\n"
            "• Produce the document in English — never mix Marathi headings.\n"
            ...
            "• Address: Hutatma Rajguru Chowk, Madam Cama Road, Mantralaya Mumbai-32\n"
            "• Use today's date for 'Dated:'\n"
            "• CRITICAL: Do NOT output any Cyrillic, Russian, Bulgarian, or non-English characters.\n\n"
            "═══════════════════════════════════════════════════\n"
    ...
    behavior = (
        "═══════════════════════════════════════════════════\n"
        "GENERAL RULES & HALLUCINATION POLICY\n"
        "═══════════════════════════════════════════════════\n"
        ...
        "• If a department name or designation is unknown, use a placeholder like [Department name required] or [विभागाचे नाव आवश्यक].\n"
        "• Do NOT invent GR numbers that could be confused with real ones — use DRAFT-[YEAR]/CR.001/XX-1 format.\n\n"
        "═══════════════════════════════════════════════════\n"
        "OUTPUT RULE\n"
        "═══════════════════════════════════════════════════\n"
    ...
    return role + template + rules + behavior

COPILOT_DRAFT = build_draft_prompt("english")
