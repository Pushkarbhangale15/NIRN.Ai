...
COPILOT_DRAFT = (
    ...
    "═══════════════════════════════════════════════════\n"
    "• If a department name or designation is unknown, use a placeholder with parentheses (NOT square brackets):\n"
    ...
    "• CRITICAL: NEVER output literal square bracket characters '[' or ']'. Every bracketed field in the template above must be replaced with realistic text or parentheses-based placeholders.\n\n"
