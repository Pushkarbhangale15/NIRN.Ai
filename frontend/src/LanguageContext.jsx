...
const translations = {
  en: {
    ...
    // Upload an existing GR
    upload_entry_title: "Upload an existing GR",
    upload_entry_desc: "Already drafted a GR as a Word file, PDF, or scanned photo? Upload it to bring it into the editor.",
    upload_dropzone_text: "Drag and drop a file here, or click to browse",
    upload_dropzone_formats: "Accepted: .docx, .pdf, .png, .jpg, .jpeg, .webp, .txt — up to 15 MB",
    upload_browse_btn: "Choose file",
    upload_selected_file: "Selected file:",
    upload_btn: "Upload & Analyze",
    upload_uploading: "Uploading…",
    upload_low_confidence_warning: "Text was recognised from a scanned image and may contain errors. Please review before proceeding.",
    status_verb_reading_document: "Reading document",
    status_verb_extracting_text: "Extracting text",
    status_verb_recognising_script: "Recognising script",

    // History page
    history_eyebrow: "History",
    history_title: "Your GR drafts",
    history_sub: "Every draft you've generated or uploaded, in one place.",

    // Conflict registry — lookup box, History expansion, detail modal
    conflict_lookup_label: "Look up a conflict",
    conflict_lookup_placeholder: "CFL-2026-004217",
    conflict_lookup_helper: "A full conflict ID also works.",
    conflict_lookup_invalid: "Enter a code like CFL-2026-004217, or a full conflict ID.",
    conflict_show_dismissed: "Show dismissed",
    conflict_hide_dismissed: "Hide dismissed",
    conflict_none_on_draft: "No conflicts on this draft.",
    conflict_all_dismissed: "All conflicts on this draft have been dismissed.",
    conflict_this_draft: "This draft",
    conflict_existing_gr: "Existing GR",
    conflict_justification: "Justification",
    conflict_detected_by_rule: "the rule engine",
    conflict_detected_by_llm: "the LLM verifier",
    conflict_detected_prefix: "Detected by",
    conflict_detected_on: "on",
    conflict_open_draft: "Open draft",
    conflict_copy: "Copy",
    conflict_copied: "Copied",
    conflict_clause_unidentified: "Clause not identified",
    conflict_from_draft: "From draft:",
    conflict_of_this_draft: "of this draft",
    conflict_of_gr: "of GR",
    conflict_the_referenced_gr: "the referenced GR",
  ...
  mr: {
    ...
    upload_entry_title: "विद्यमान शासन निर्णय अपलोड करा",
    upload_entry_desc: "आधीच वर्ड फाईल, पीडीएफ किंवा स्कॅन केलेला फोटो म्हणून शासन निर्णय तयार केला आहे? तो संपादकात आणण्यासाठी अपलोड करा.",
    upload_dropzone_text: "फाईल येथे ड्रॅग आणि ड्रॉप करा, किंवा ब्राउझ करण्यासाठी क्लिक करा",
    upload_dropzone_formats: "स्वीकार्य: .docx, .pdf, .png, .jpg, .jpeg, .webp, .txt — कमाल १५ MB",
    upload_browse_btn: "फाईल निवडा",
    upload_selected_file: "निवडलेली फाईल:",
    upload_btn: "अपलोड करा आणि विश्लेषण करा",
    upload_uploading: "अपलोड करत आहे…",
    upload_low_confidence_warning: "स्कॅन केलेल्या प्रतिमेतून मजकूर ओळखला गेला असून त्यात त्रुटी असू शकतात. कृपया पुढे जाण्यापूर्वी पुनरावलोकन करा.",
    status_verb_reading_document: "दस्तऐवज वाचत आहे",
    status_verb_extracting_text: "मजकूर काढत आहे",
    status_verb_recognising_script: "लिपी ओळखत आहे",

    history_eyebrow: "इतिहास",
    history_title: "तुमचे शासन निर्णय मसुदे",
    history_sub: "तुम्ही तयार केलेला किंवा अपलोड केलेला प्रत्येक मसुदा, एकाच ठिकाणी.",

    conflict_lookup_label: "संघर्ष शोधा",
    conflict_lookup_placeholder: "CFL-2026-004217",
    conflict_lookup_helper: "पूर्ण संघर्ष आयडी देखील चालेल.",
    conflict_lookup_invalid: "CFL-2026-004217 सारखा कोड किंवा पूर्ण संघर्ष आयडी टाका.",
    conflict_show_dismissed: "नाकारलेले दाखवा",
    conflict_hide_dismissed: "नाकारलेले लपवा",
    conflict_none_on_draft: "या मसुद्यात कोणतेही संघर्ष नाहीत.",
    conflict_all_dismissed: "या मसुद्यावरील सर्व संघर्ष नाकारले गेले आहेत.",
    conflict_this_draft: "हा मसुदा",
    conflict_existing_gr: "विद्यमान शासन निर्णय",
    conflict_justification: "समर्थन",
    conflict_detected_by_rule: "नियम इंजिन",
    conflict_detected_by_llm: "एआय पडताळणी",
    conflict_detected_prefix: "आढळले",
    conflict_detected_on: "रोजी, द्वारे:",
    conflict_open_draft: "मसुदा उघडा",
    conflict_copy: "कॉपी करा",
    conflict_copied: "कॉपी झाले",
    conflict_clause_unidentified: "परिच्छेद ओळखला नाही",
    conflict_from_draft: "मसुद्यातून:",
    conflict_of_this_draft: "या मसुद्याचा",
    conflict_of_gr: "या शासन निर्णयाचा",
    conflict_the_referenced_gr: "संदर्भित शासन निर्णय",
